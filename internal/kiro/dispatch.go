	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				{Name: "idc_start_url", Type: pluginapi.ConfigFieldTypeString, Description: "Organization IAM Identity Center portal start URL. Default for new logins; empty means AWS Builder ID."},
				{Name: "idc_region", Type: pluginapi.ConfigFieldTypeString, Description: "AWS Region that hosts your Identity Center instance."},
				{Name: "account_label", Type: pluginapi.ConfigFieldTypeString, Description: "Optional label appended to the auth label to tell multiple Kiro accounts apart."},
			},
		},
